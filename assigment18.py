...
dict={}
name=["vijay","ram","gopal","yash","rahul","avi","kunal","prthvi","suruchi","surbhi","khush","sweet"]
...
button=Button(text="Get Number",width=20,bg='blue',fg='black',command=show)
button.pack()
...
dict={}
name=["Vijay","yash","dheeraj","ram","rahul","gopal","suruchi","sweet","rohit","bikram","rajat","raj"]
number=[4962963,9461,84616456,1653448,6549813131,16516516,65165156,3146,5132162,16586521616,16516515,1651616]
for i in range(len(name)):
    dict[name[i]]=number[i]
